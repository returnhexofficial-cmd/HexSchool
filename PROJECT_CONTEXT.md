...
> **Last updated:** 2026-07-18 (Module 10 complete — admission cycles/applications with public OTP+reCAPTCHA portal, snapshots, offline payments, tests + merit/waitlist engine w/ expiry job, admit-card PDFs, conversion via StudentsService; AuthModule exports OtpService, StudentModule exports StudentsService)
...
- **M09:** batch ID cards take an explicit `studentIds[]`; SECTION-scoped batches (`POST /sections/:id/id-cards`) wait for M11 rosters.
