...
- After 18: ~~**19 (Website)** ∥ **20 (Accounting)** ∥ **21 (HR & Payroll)**~~ — all done. ~~**22**~~ ~~**23**~~ ~~**25**~~ ~~**24**~~ ~~**26**~~ ~~**27**~~ done; **28** is the last of the mutually-independent band (M25, M24, M26 and M27 exercised it and nothing crossed between any of them — M27 touched M26 only to *add* a clearance service, additively); only **29** waits on 21 (and now also on 22 for submission analytics, 23 for reading history, 25 for route-level cost analytics, 24 for consumption analytics and asset depreciation, 26 for occupancy-over-time and cost-per-bed, and 27 for issuance-rate analytics).
